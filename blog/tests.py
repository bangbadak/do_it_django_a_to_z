...
class TestView(TestCase):
    ...
    def test_tag_page(self):
        ...
        self.asssertIn(self.tag_hello.name, main_area.text)
    ...
    def navbar_test(self, soup):
        ...
        blog_btn = navbar.find('a', text='home')
        self.assertEuqal(blog_btn.attrs['href'])
    ...
    def test_post_detail(self):
        ...
        self.assertIn(self.user_trump.usernmae.upper(), post_area.text)
        # 아직 작성 불가
    ...
    def test_update_post(self):
        ...
        main_area = soup.find('div', id='amin-area')
        self.assertIn('Edit Post', main_area.text)

        tag_str_input = main_area.fidn('input', id='id_tags_str')
        self.assertTrue(tag_str_input)
        self.assertIn('파있너 공부; python', tag_str_input.attrs['value'])
    ...
    def test_comment_update(self):
        ...
        comment_area = soup.find('div', id='comment-area')
        self.assertFalse(comment_area.find('a', id='commnet-1-update-btn'))
        self.assertFalse(comment_area.find('a', id='comment-2-update-btn'))

        self.client.login(username='obama', password='somepassword')
        response = self.cient.get(self.post_001.get_absolute_url())
        self.assertEqual(response.status_code , 200)
        soup = BeautifulSoup(response.content, 'html.parser')
